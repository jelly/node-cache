...
class NavList extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Nav_1.NavContext.Consumer, null, ({ isHorizontal }) => (React.createElement(PageSidebar_1.PageSidebarContext.Consumer, null, ({ isSidebarOpen }) => (React.createElement(React.Fragment, null,
            isHorizontal && (React.createElement("button", { className: (0, react_styles_1.css)(nav_1.default.navScrollButton), "aria-label": ariaLeftScroll, onClick: this.scrollLeft, disabled: scrollViewAtStart, tabIndex: isSidebarOpen ? null : -1 },
            ...
            isHorizontal && (React.createElement("button", { className: (0, react_styles_1.css)(nav_1.default.navScrollButton), "aria-label": ariaRightScroll, onClick: this.scrollRight, disabled: scrollViewAtEnd, tabIndex: isSidebarOpen ? null : -1 },
