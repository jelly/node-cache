...
const ModalBoxCloseButton = (_a) => {
    ...
    return (React.createElement("div", { className: (0, react_styles_1.css)(modal_box_1.default.modalBoxClose, className) },
        React.createElement(Button_1.Button, Object.assign({ variant: "plain", onClick: (event) => onClose(event), "aria-label": "Close" }, (ouiaId && { ouiaId: `${ouiaId}-${exports.ModalBoxCloseButton.displayName}` }), props),
