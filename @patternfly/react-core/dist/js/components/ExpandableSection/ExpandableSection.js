...
class ExpandableSection extends React.Component {
    ...
    render() {
        ...
        const expandableToggle = !isDetached && (React.createElement("button", { className: (0, react_styles_1.css)(expandable_section_1.default.expandableSectionToggle), type: "button", "aria-expanded": propOrStateIsExpanded, onClick: (event) => onToggle(event, !propOrStateIsExpanded) },
