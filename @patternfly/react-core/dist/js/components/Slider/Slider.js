...
const Slider = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(slider_1.default.slider, className, isDisabled && slider_1.default.modifiers.disabled), style: Object.assign(Object.assign({}, style), inputStyle) }, props),
        leftActions && React.createElement("div", { className: (0, react_styles_1.css)(slider_1.default.sliderActions) }, leftActions),
        ...
        isInputVisible && inputPosition === 'right' && React.createElement("div", { className: (0, react_styles_1.css)(slider_1.default.sliderValue) }, displayInput()),
        rightActions && React.createElement("div", { className: (0, react_styles_1.css)(slider_1.default.sliderActions) }, rightActions)));
};
