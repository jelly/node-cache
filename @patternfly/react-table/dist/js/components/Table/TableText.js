...
const TableText = (_a) => {
    var { children = null, className = '', variant = 'span', wrapModifier = null, tooltip: tooltipProp = '', tooltipProps = {}, onMouseEnter: onMouseEnterProp = () => { }, focused = false } = _a, props = tslib_1.__rest(_a, ["children", "className", "variant", "wrapModifier", "tooltip", "tooltipProps", "onMouseEnter", "focused"]);
    ...
    const text = (React.createElement(Component, Object.assign({ ref: textRef, onMouseEnter: onMouseEnter, className: (0, react_styles_1.css)(className, wrapModifier && table_1.default.modifiers[wrapModifier], table_1.default.tableText) }, props), children));
    React.useEffect(() => {
        if (focused) {
    ...
    return tooltip !== '' ? (React.createElement(Tooltip_1.Tooltip, Object.assign({ triggerRef: textRef, content: tooltip, isVisible: true }, tooltipProps), text)) : (text);
};
