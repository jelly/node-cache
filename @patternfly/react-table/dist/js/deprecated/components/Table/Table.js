...
const components_1 = require('@patternfly/react-core/dist/js/deprecated/components');
...
class Table extends React.Component {
    ...
    render() {
        ...
        const headerData = (0, components_3.calculateColumns)(cells, {
            sortBy,
            onSort,
            onSelect,
            canSelectAll: selectVariant === components_3.RowSelectVariant.radio ? false : canSelectAll,
            canCollapseAll,
        ...
        const table = (React.createElement(TableContext_1.TableContext.Provider, { value: {
            ...
            React.createElement(provider_1.Provider, Object.assign({}, props, { "aria-label": ariaLabel, renderers: {
                    body: {
                        ...
                        row: rowWrapper || (this.props.isTreeTable ? components_4.TreeRowWrapper : components_2.RowWrapper),
...
Table.defaultProps = {
    ...
    dropdownPosition: components_1.DropdownPosition.right,
    dropdownDirection: components_1.DropdownDirection.down,
    actionsMenuAppendTo: 'inline',
    header: undefined,
    caption: undefined,
    'aria-label': undefined,
    gridBreakPoint: components_4.TableGridBreakpoint.gridMd,
    role: 'grid',
    canSelectAll: true,
